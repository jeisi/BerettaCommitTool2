 ...
 * @author jeisi
 */
public class GitMergeAbortSelectionSituation implements Situation {

    private final RepositoriesInfo repositories;
    private final ObjectProperty<TargetRepository> targetRepository;

    public GitMergeAbortSelectionSituation(RepositoriesInfo repositories, ObjectProperty<TargetRepository> targetRepository) {
    ...
    public boolean isValid() {
        ...
        return targetRepositories.stream().allMatch(p -> p.isMerging());
    }
