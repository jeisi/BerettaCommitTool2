 ...
 * @author jeisi
 */
public class GitCheckIgnoreSelectionSituation implements Situation {
    ...
    public GitCheckIgnoreSelectionSituation(MultipleSelectionModel<GitStatusData> selectionModel) {
