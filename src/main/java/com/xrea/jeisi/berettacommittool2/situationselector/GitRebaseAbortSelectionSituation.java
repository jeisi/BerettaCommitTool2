 ...
 * @author jeisi
 */
public class GitRebaseAbortSelectionSituation implements Situation {

    private final RepositoriesInfo repositories;
    private final ObjectProperty<TargetRepository> targetRepository;

    public GitRebaseAbortSelectionSituation(RepositoriesInfo repositories, ObjectProperty<TargetRepository> targetRepository) {
    ...
    public boolean isValid() {
        ...
        return targetRepositories.stream().allMatch(p -> p.isRebasing());
    }
