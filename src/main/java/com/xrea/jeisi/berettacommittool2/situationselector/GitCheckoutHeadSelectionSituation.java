 ...
 * @author jeisi
 */
public class GitCheckoutHeadSelectionSituation implements Situation {
    ...
    public GitCheckoutHeadSelectionSituation(MultipleSelectionModel<GitStatusData> selectionModel) {
